...
const hotQuestions = [
  ...
  { _id: 2, title: "How do I write NextJS components?" },
  { _id: 3, title: "Is NextJS and React the same thing?" },
  { _id: 4, title: "Should I learn C?" },
  { _id: 5, title: "Do I need a CS degree?" },
];
...
const popularTags = [
  ...
  { _id: 4, name: "node", totalQuestions: 1 },
  { _id: 5, name: "typescript", totalQuestions: 20 },
];
